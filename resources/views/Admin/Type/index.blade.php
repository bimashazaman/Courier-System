...
@section('content')
    <div class="content p-4">
        <h2 class="mb-4" style="text-transform: uppercase;">All Type List
            <a href="{{ route('admin.courier.create') }}" class="btn btn-primary btn-md float-right">
                ...
                <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                    ...
                    @foreach($courierTypeList as $courierType)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.courier.edit',$courierType->id) }}"><button class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> EDIT</button></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
