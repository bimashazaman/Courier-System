...
@section('content')
    <div class="content p-4">
        <h2 class="mb-4" style="text-transform: uppercase;">Edit Type
            <a href="{{ route('admin.courier.index') }}" class="btn btn-primary btn-md float-right">
                <i class="fa fa-list"></i>   View Type
            </a>
        </h2>
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('admin.courier.update',$type->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <br>
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-primary btn-block btn-lg">Update Type</button>
                    </div>
                </form>
            </div>
        </div>
