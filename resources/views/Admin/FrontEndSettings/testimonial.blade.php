...
@section('content')
    ...
    <div class="content p-4">
        <h2 class="mb-4" style="text-transform: uppercase;">Testimonial Setting
            <a href="{{route('')}}" class="btn btn-primary btn-md float-right" data-toggle="modal" data-target="#addNew">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('admin.frontend.testimonialUpdate') }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="editTestimonial{{ $testimonial->id }}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.frontend.testimonialUpdate',$testimonial->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                        ...
                                        <div class="modal fade" id="delete" role="dialog" aria-labelledby="#delete" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('admin.frontend.deleteTestimonial',$testimonial->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('admin.frontend.storeNewTestimonial') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="image" class="col-sm-3 control-label bold uppercase"><strong>Image :</strong> </label>
