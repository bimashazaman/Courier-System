    ...
    <div class="content p-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('admin.frontend.servicesUpdate') }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="editService{{ $services->id }}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="{{ route('admin.frontend.updateNewServices',$services->id) }}">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                        ...
                                        <div class="modal fade" id="delete" role="dialog" aria-labelledby="#delete" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('admin.frontend.deleteServices',$services->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('admin.frontend.storeNewServices') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="title" class="col-sm-3 control-label bold uppercase"><strong>Title :</strong> </label>
