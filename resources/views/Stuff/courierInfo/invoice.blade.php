...
{{--                            </table>--}}
            ...
            <div class="row mb-2 ml-2">
                <div class="container">
                    ...
                    <a href="{{ route('stuff.courier.slip',$courierInfo->id) }}" target="_blank"><button class="btn btn-primary"><i class="fa fa-print"></i> Print Slip</button></a>
                    @if($courierInfo->payment_status == 'Unpaid')
                            ...
                            <div class="modal fade" id="receive{{ $courierInfo->id }}" role="dialog" aria-labelledby="#" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{ route('stuff.courier.payment') }}">
                                            @csrf
                                            @method('PUT')
