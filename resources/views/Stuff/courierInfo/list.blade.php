...
@section('content')
    ...
    <div class="content p-4">
        <h2 class="mb-4" style="text-transform: uppercase;">All Courier List
            <a href="{{ route('stuff.courier.create') }}" class="btn btn-primary btn-md float-right">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        <form method="GET" action="{{ route('stuff.courier.index') }}" class="form-inline">
                            @csrf
                    ...
                    <div class="col-md-4  mb-2">
                        <form method="GET" action="{{ route('stuff.courier.index') }}" class="form-inline float-right">
                            @csrf
                ...
                <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                    ...
                    @forelse($courierList as $key=>$courier)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('stuff.courier.invoice',$courier->invoice_id) }}"><button class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i> Courier Invoice</button></a>
                            </td>
                        </tr>
                    @empty
                        <tr>
