...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('general_settings')->insert([
            'title' => 'bimasha',
            'header_title' => 'bimasha',
            'header_subtitle' => 'bimasha is a Branch based courier management system. Courier or Parcel Sender will send from a branch. Receiver will receive from destination branch set on sending !',
