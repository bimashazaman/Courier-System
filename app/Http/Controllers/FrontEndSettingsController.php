...
class FrontEndSettingsController extends Controller
{
    public function logoicon() {
        return view('Admin.FrontEndSettings.logoicon');
    }
    ...
    public function social() {
        ...
        return view('Admin.FrontEndSettings.socialLink', compact('socialList'));
    }
    ...
    public function background() {
        return view('Admin.FrontEndSettings.background');
    }
    ...
    public function headertextsetting() {
        ...
        return view('Admin.FrontEndSettings.headerText', compact('setting'));
    }
    ...
    public function couriercount() {
        $setting = GeneralSetting::first();
        return view('Admin.FrontEndSettings.CourierCount', compact('setting'));
    }
    ...
    public function aboutus() {
        $setting = GeneralSetting::first();
        return view('Admin.FrontEndSettings.aboutus', compact('setting'));
    }
    ...
    public function contactus() {
        $setting = GeneralSetting::first();
        return view('Admin.FrontEndSettings.contactus', compact('setting'));
    }
    ...
    public function footer() {
        $setting = GeneralSetting::first();
        return view('Admin.FrontEndSettings.footer', compact('setting'));
    }
    ...
    public function showVisitorMessage() {
        $visitorMessageList = VisitorMassage::all();
        return view('Admin.visitorMassage.list', compact('visitorMessageList'));
    }

    public function deleteVisitorMessage($id) {
        VisitorMassage::destroy($id);
        return back()->withSuccess("Information deleted successfully");
    }
    ...
    public function services() {
        ...
        return view('Admin.FrontEndSettings.service', compact('setting', 'servicesList'));
    }
    ...
    public function testimonial() {
        ...
        return view('Admin.FrontEndSettings.testimonial', compact('setting', 'testimonialList'));
    }
    ...
    public function searchcourier() {
        $setting = GeneralSetting::first();
        return view('Admin.FrontEndSettings.searchCourier', compact('setting'));
    }
    ...
    public function faq() {
        $setting = GeneralSetting::first();
        $faqList = Faq::all();
        return view('Admin.FrontEndSettings.faq', compact('setting', 'faqList'));
    }
